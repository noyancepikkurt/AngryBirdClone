...
//  AngryBirdClone
//
//  Created by Noyan Çepikkurt on 26.11.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let size = CGSize(width: boxTexture.size().width / 7.4, height: boxTexture.size().height / 7.4)
        ...
        originalPosition2 = box1.position
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if let birdPhysicsBody = bird.physicsBody {
            ...
            if birdPhysicsBody.velocity.dx <= 0.1 && birdPhysicsBody.velocity.dy <= 0.1 && birdPhysicsBody.angularVelocity <= 0.1 && gameStarted == true {
                ...
                box1.position = originalPosition2!
